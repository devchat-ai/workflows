...
- Maintain isolated work environments
...
- Ensure that changes on the current branch are committed
- If an Issue URL is provided, the Issue number will be automatically linked to the branch name
